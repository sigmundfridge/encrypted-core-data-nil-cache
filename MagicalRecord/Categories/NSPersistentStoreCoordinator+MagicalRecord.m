...
- (NSPersistentStore *) MR_addSqliteStoreNamed:(id)storeFileName withOptions:(__autoreleasing NSDictionary *)options
{
    ...
    NSDictionary *encOptions = @{EncryptedStorePassphraseKey:@"key"};
...
+ (NSPersistentStoreCoordinator *) MR_coordinatorWithAutoMigratingSqliteStoreNamed:(NSString *) storeFileName
{
    ...
    NSPersistentStore* store = [coordinator MR_addAutoMigratingSqliteStoreNamed:storeFileName];
...
{
    NSManagedObjectModel *model = [NSManagedObjectModel MR_defaultManagedObjectModel];
    NSPersistentStoreCoordinator *psc = [EncryptedStore makeStore:model passcode:@"key"];
